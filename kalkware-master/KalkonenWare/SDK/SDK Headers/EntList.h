...
public:
	...
	CBaseEntity *GetClientEntityFromHandle_(CBaseHandle hEnt)
	{
	...
	CBaseCombatWeapon* GetPClientEntity(int index)
	{
		typedef CBaseCombatWeapon* (__thiscall* GetClientEntityFn)(void*, int);
		return getvfunc <GetClientEntityFn>(this, 3)(this, index);
	}
