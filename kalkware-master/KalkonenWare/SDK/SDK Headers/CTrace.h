...
public:
	...
	{
		typedef void(__thiscall* fnClipRayToEntity)(void*, const Ray_t&, unsigned int, CBaseEntity*, trace_t*);
	...
	int		GetPointContents_(const Vector &vecAbsPosition, int contentsMask = MASK_ALL, CBaseEntity** ppEntity = NULL)
	{
		typedef int(__thiscall* fnGetPointContents)(void*, const Vector&, int, CBaseEntity**);
		return getvfunc<fnGetPointContents>(this, 0)(this, vecAbsPosition, contentsMask, ppEntity);
	}

	void	ClipRayToEntity_(const Ray_t &ray, unsigned int fMask, CBaseEntity *pEnt, trace_t *pTrace)
	{
		typedef void(__thiscall* fnGetPointContents)(void*, const Ray_t&, unsigned int, CBaseEntity*, trace_t*);
		return getvfunc<fnGetPointContents>(this, 3)(this, ray, fMask, pEnt, pTrace);
	}

	void TraceRay_(const Ray_t &ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t* pTrace)
	{
		typedef void(__thiscall* fnTraceRay)(void*, const Ray_t&, unsigned int, ITraceFilter*, trace_t*);
		getvfunc<fnTraceRay>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}
