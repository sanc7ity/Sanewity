...
namespace ImGui
{
	...
	IMGUI_API bool          ColorEdit3(const char* label, float col[3], bool HealthBased = false, bool* HBVariable = nullptr, ImGuiColorEditFlags flags = 0);
	IMGUI_API bool          ColorEdit4(const char* label, float col[4], bool HealthBased = false, bool* HBVariable = nullptr, ImGuiColorEditFlags flags = 0);
	IMGUI_API bool          ColorPicker3(const char* label, float col[3], bool HealthBased = false, bool* HBVariable = nullptr, ImGuiColorEditFlags flags = 0);
	IMGUI_API bool          ColorPicker4(const char* label, float col[4], bool HealthBased = false, bool* HBVariable = nullptr, ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
...
struct ImDrawList
{
	...
	inline    void  PriClientVarstx(const ImVec2& pos, const ImVec2& uv, ImU32 col) { PrimWriteIdx((ImDrawIdx)_VtxCurrentIdx); PrimWriteVtx(pos, uv, col); }
