...
void ImGui::StyleColorsClassic(ImGuiStyle* dst)
{
	...
	colors[ImGuiCol_WindowBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
	...
	colors[ImGuiCol_MenuBarBg] = ImVec4(0.8f, 0.8f, 0.8f, 0.80f);
	...
	colors[ImGuiCol_Button] = ImVec4(1.f, 1.f, 1.f, 0.62f);
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.8f, 0.8f, 0.8f, 0.79f);
...
void ImGui::StyleColorsDark(ImGuiStyle* dst)
{
	...
	colors[ImGuiCol_Border] = ImVec4(1.f, 1.f, 1.f, 1.f);
	colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	...
	colors[ImGuiCol_CheckMarkHover] = ImVec4(0.6f, 0.6f, 0.6f, 0.70f);
